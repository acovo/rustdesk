<p align="center">
  ...
  <b>Нам потрібна ваша допомога для перекладу цього README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">інтерфейсу</a> та <a href="https://github.com/rustdesk/doc._">документації</a> RustDesk на вашу рідну мову</B>
</p>
...
## [Збирання](https://_/docs/en/dev/build/)
