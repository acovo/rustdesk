...
Puoi usare il nostro server rendezvous/relay, [configurare il tuo server](https://_/server) o [realizzare il tuo server rendezvous/relay](https://github.com/rustdesk/rustdesk-server-demo).
