...
pub const LINK_DOCS_HOME: &str = "https://_/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://_/docs/en/manual/linux/#x11-required";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs-ny._"];
